...
enum class Keyword: uint64_t {
    ...
    // Triggers
    ON_TURN_START = 1ull << 10,
    ON_TURN_END = 1ull << 21,
    ON_DAMAGE_SELF = 1ull << 22,
    ON_DAMAGE_OTHER = 1ull << 23,
    ON_DAMAGE_PLAYER = 1ull << 24,
    ON_ADD = 1ull << 25,
    ON_PLAY = 1ull << 26,
    ON_SUMMON = 1ull << 27,
    ON_ATTACK = 1ull << 28,
    ON_KILL = 1ull << 29,
    OVERKILL = 1ull << 30,
    ON_DEATH_OTHER = 1ull << 31,
    ON_PRE_ATTACK = 1ull << 32,
    ON_POST_ATTACK = 1ull << 33,
    ON_LOSE_DIVINE_SHIELD = 1ull << 34,
    ON_START_OF_COMBAT = 1ull << 35,
};
