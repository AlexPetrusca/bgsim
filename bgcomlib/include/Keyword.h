...
enum class Keyword: uint64_t {
    ...
    IMMUNE = 1ull << 16,
    AURA = 1ull << 17,
    ADJACENT_AURA = 1ull << 18,
    LEGENDARY = 1ull << 19,
    SPECIAL = 1ull << 20,

    // Triggers
    ON_TURN_START = 1ull << 21,
    ON_TURN_END = 1ull << 22,
    ON_DAMAGE_SELF = 1ull << 23,
    ON_DAMAGE_OTHER = 1ull << 24,
    ON_DAMAGE_PLAYER = 1ull << 25,
    ON_ADD = 1ull << 26,
    ON_PLAY = 1ull << 27,
    ON_SUMMON = 1ull << 28,
    ON_ATTACK = 1ull << 29,
    ON_KILL = 1ull << 30,
    OVERKILL = 1ull << 31,
    ON_DEATH_OTHER = 1ull << 32,
    ON_PRE_ATTACK = 1ull << 33,
    ON_POST_ATTACK = 1ull << 34,
    ON_LOSE_DIVINE_SHIELD = 1ull << 35,
    ON_START_OF_COMBAT = 1ull << 36,
};
